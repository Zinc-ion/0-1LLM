...
def train_tokenizer():
     ...
     with open(os.path.join(tokenizer_dir, "tokenizer_config.json"), "w", encoding="utf-8") as f:
          json.dump(config, f, ensure_ascii=False, indent=4) # indent=4表示缩进4个空格
